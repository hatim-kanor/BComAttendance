...
public class tybcom_main extends AppCompatActivity {
    Button a, b, c,d;
    LinearLayout ll_1,ll_2,ll_3;
    Button AB1,AB2,AB3,AB4,AB5,AB6,AB7;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.tybcom_main);
        ...
        //AB7 = (Button)findViewById(R.id.AB7);
        ...
        a.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(getApplicationContext(), A_Tybcom.class);
                i.putExtra("div", "A");
                startActivity(i);
                finish();
            }
...
//                startActivity(i);
//                finish();
                final AlertDialog dialog = new AlertDialog.Builder(tybcom_main.this)
                ...
                negativeButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        dialog.dismiss();
                        Intent intent11 = new Intent(tybcom_main.this,A_Tybcom.class);
                        intent11.putExtra("div", "C");
        ...
        AB1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i1 = new Intent(getApplicationContext(), Tybcom_Computer.class);
                i1.putExtra("div", "tybcom_C");
